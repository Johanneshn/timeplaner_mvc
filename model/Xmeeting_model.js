...
function Activity(name,length,typeid,description){
	...
	// sets the uniqueId of the activity 
	/*
	...
	// Returns data from activity depending on the unique ID --- Funkar ejj 
	/*
	this.getData = function (uniqueId) {
		//return this._name;
		
		$.each(this._activitiesArr,function(index,activity){
			
			if(activity._uniqueId == uniqueId){
				return this._name; 
